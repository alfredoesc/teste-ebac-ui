class EnderecoPage {
    ...
    editarEnderecoFaturamento(nome, sobrenome, empresa, pais, endereco, numero, cidade, estado, cep, telefone, email) {
        ...
        //cy.get('#select2-billing_state-container').click().type('Rio Grande do Sul').get('[aria-selected="true"]').click()
    ...
    editarEnderecoEntrega() {
        ...
        cy.get('#shipping_first_name')
        cy.get('#shipping_last_name')
        ...
        cy.get('#shipping_city')
        cy.get('#select2-shipping_state-container').click().type('Rio Grande do Sul').get('[aria-selected="true"]').click()
        cy.get('#shipping_postcode')
